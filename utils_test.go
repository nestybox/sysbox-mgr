...
func TestAllocSubidRange(t *testing.T) {
	...
	want = append(subID, user.SubID{"sysvisor", 231072, 65536})
	...
	want = append(subID, user.SubID{"sysvisor", 100000, 65536})
	compareSubidRanges(t, want, got)
	...
	want = append(subID, user.SubID{"sysvisor", 165536, 65536})
	compareSubidRanges(t, want, got)
	...
	want = append(subID, user.SubID{"sysvisor", 165535, 1})
	compareSubidRanges(t, want, got)
